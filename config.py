...
# 以下参数根据自己的需要进行修改：
SYS_CONFIG = {eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2OTQ0ODc2NjYsIm5iZiI6MTY2MzM4NTQ2NiwiaWF0IjoxNjYzMzgzNjY2LCJqdGkiOiJDTTpjYXRfbWF0Y2g6bHQxMjM0NTYiLCJvcGVuX2lkIjoiIiwidWlkIjo0MDkxMjIzNywiZGVidWciOiIiLCJsYW5nIjoiIn0.3c-wLNtjVXczQygiN7OE_WBU04-H4dMvbF4tbhT2ghA
    ...
    "header_t": "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.138 Safari/537.36 MicroMessenger/7.0.4.501 NetType/WIFI MiniProgramEnv/Windows WindowsWechat/WMPF",
